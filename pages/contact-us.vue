                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body box-style">
                                    <form @submit.prevent="sendMessage">
                                        ...
                                        <button
                                            type="submit"
                                            class="btn btn-primary mt-5 btn-edit"
                                        >
                                            <span v-if="loader"
                                                >SEND MESSAGE
                                                <font-awesome-icon
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <p class="help-text">
                                Please select a topic below related to your
                                inquiry. If you don’t find what you need, fill
        ...
        sendMessage() {
            ...
            this.$validator.validateAll().then(async (valid) => {
                if (valid) {
                    ...
                    this.$axios
                        .post(
                            "https://hamlet.payfill.co/api/contact-us",
                            formData
                        )
                        .then((res) => {
                            this.loader = true;
