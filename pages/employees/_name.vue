                ...
                <div class="one1">
                    <div v-for="item in employee" :key="item.id">
                        <img
                            ...
                            :src="`${
                                item.profile_pic || '~/assets/Group 58.png'
                            }`"
                            alt
                        />
                    </div>
                ...
                <div v-else>
                    ...
                    <div class="one6">
                        <div class="one7">
                            <div v-for="item in employee" :key="item.id">
                                ...
                                <h5>
                                    Job Title:
                                    {{ item.job_details.job_title }} || Date
                                    Hired:
                    ...
                    <div id="Personal">
                        ...
                        <div
                            ...
                            v-else
                        >
                            <h3 style="color: #0065fc">
                                Edit Employee Information
                            </h3>
                            <hr />
                            <form
                                @submit.prevent="
                                    updateEmployeeInfo(employeeDetails.id)
                                "
                            >
                                <div class="grid">
                                    <p>First Name</p>
                                ...
                                <div class="grid">
                                    ...
                                    <div class="input-group">
                                        <select
                                            class="custom-select p-1 form-control"
                                            name="gender"
                                ...
                                <div class="grid">
                                    ...
                                    <input
                                        ...
                                        @change="upload()"
                                        v-validate="
                                            'required|ext:jpeg,jpg,svg,png'
                                        "
                                        :class="{
                                            'is-invalid':
                                                submitted &&
                                                errors.has('profile-picture'),
                                        }"
                                    />
                                    <div></div>
                                    <small id class="form-text text-muted"
                                        >(Picture must be of .jpeg, .png, .svg,
                                        .jpg format)</small
                                    >
                                    <div></div>
                                    <small
                        ...
                        <div class="one3">
                            <div v-if="editJobDetails">
                                ...
                                <div class="grid">
                                    ...
                                    <p>
                                        {{
                                            job_details.employment_classification
                                        }}
                                    </p>
                                </div>
                                <div class="grid">
                            ...
                            <div id="form" v-else>
                                ...
                                <form
                                    @submit.prevent="
                                        updateJobDetails(jobDetails.employee_id)
                                    "
                                >
                                    <div class="grid">
                                        <p>Job Title</p>
                                        ...
                                        <div class="input-group" v-if="radio1">
                                            <label class="container">
                                                ...
                                                <input
                                                    ...
                                                    value="Full Time"
                                                    v-model="
                                                        jobDetails.employment_classification
                                                    "
                                                />
                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="input-group">
                                            <select
                                                class="custom-select form-control p-1"
                                                id="inputGroupSelect04"
                                                name="job-category"
                    ...
                    <div id="Contact">
                        <div class="one3">
                            <div v-if="editContactInfo">
                                ...
                                <button
                                    class="btn2"
                                    @click="editContact(contact_info)"
                                >
                                    Edit Contact Info
                                </button>
                            </div>
...
export default {
    ...
    mounted() {
        this.$axios
            .get(
                `https://hamlet.payfill.co/api/employees/${this.$route.params.name}`
            )
            .then((res) => {
    ...
    methods: {
        ...
        getDepartment() {
            this.$axios
                ...
                .then((res) => {
                    ...
                    this.departments =
                        res.data.user.company.company_departments;
                    this.show = true;
                });
        },
        openNav() {
        ...
        updateContactInfo(i) {
            swal({
                title: "Are you sure?",
                text:
                    "Once you Update, previous Contact Information will be lost",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        this.$message({
                            message:
                                "Employee Contact information remains the same !",
                            type: "info",
                        });
                    }
                })
        ...
        updateEmployeeInfo(i) {
            ...
            this.$validator.validateAll().then((valid) => {
                if (valid) {
                    ...
                    formData.append(
                        "other_names",
                        this.employeeDetails.other_names
                    );
                    ...
                    formData.append(
                        "qualification",
                        this.employeeDetails.qualification
                    );
                    formData.append(
                        "profile_pic",
                        this.employeeDetails.profile_pic
                    );
                    formData.append("_method", "PUT");
                    this.$axios
                        .post(
                            `https://hamlet.payfill.co/api/employee/${i}`,
                            formData,
                            {
                                headers: {
                                    Authorization: `Bearer ${this.user}`,
                        ...
                        .then((res) => {
                            ...
                            this.$message({
                                message:
                                    "You've updated your employee's personal details!",
                                type: "success",
                            });
                            this.$router.push("/dashboard");
                            this.isLoading = true;
...
.file-border {
    padding: 1rem 5rem 3rem 1rem !important;
