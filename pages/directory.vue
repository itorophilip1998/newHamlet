                ...
                <div class="col-sm-2 d-none d-lg-block d-xl-block">
                    ...
                    <div class="side-bar">
                        ...
                        <h5 class="mt-3 text-center">
                            {{ this.profile_pic.first_name }}
                            {{ this.profile_pic.last_name }}
                        </h5>
                        <input
                            type="search"
                        ...
                        <select
                            ...
                            id="department"
                            @input="filterDepartments = getDepartment()"
                    ...
                    <div>
                        <div class="mt-5">
                            ...
                            <div class="main-panel" v-else>
                                ...
                                <table
                                    class="table border-0 rounded-lg mt-3 rounded-lg table-responsive-lg"
                                >
                                    <thead
                                        style="
                                    ...
                                    >
                                        <tr
                                            ...
                                            :key="index"
                                            @click="
                                                linksingleEmployee(employee.id)
                                            "
                                        >
                                            <th
                                                scope="row"
                ...
                return this.employees.filter((post) => {
                    return (
                        post.first_name
                            .toLowerCase()
                            .match(
                                this.filterbyName.toLowerCase() ||
                                    this.filterbyName.toUpperCase()
                            ) ||
                        post.city
                            .toLowerCase()
                            .match(
                        ...
                        post.job_details.job_title
                            .toLowerCase()
                            .match(
                                this.filterbyName.toLowerCase() ||
                                    this.filterbyName.toUpperCase()
                            ) ||
                        post.job_details.employment_type
                            .toLowerCase()
                            .match(
                                this.filterbyName.toLowerCase() ||
                                    this.filterbyName.toUpperCase()
                            ) ||
                        post.job_details.department
                            .toLowerCase()
                            .match(
                                this.filterbyName.toLowerCase() ||
                                    this.filterbyName.toUpperCase()
                            ) ||
                        post.job_details.description
                            .toLowerCase()
                            .match(
                                this.filterbyName.toLowerCase() ||
                                    this.filterbyName.toUpperCase()
